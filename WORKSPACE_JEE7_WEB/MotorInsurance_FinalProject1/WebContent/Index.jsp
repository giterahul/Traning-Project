				...
				<div class="top-header">
					<div class="container">
						<a href="index.html" id="branding">
							<img src="https://watermann-zink.de/wp-content/uploads/2017/05/ALLIANZ-LOGO-1.png" alt="Company Name" class="logo">
							<div class="logo-text">
					...
					<li data-bg-image="dummy/slide-1.jpg">
						<div class="container">
							<div class="slide-content">
								<h2 class="slide-title">Our Service Has No Speed Limit<strong></strong></h2>
