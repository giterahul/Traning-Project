...
<%@page import="com.allianz.shopping.model.Product"%>
						...
						<c:forEach items="${productList}" var="product" varStatus="status">
							...
							<tr>
								...
								<td><input type="text" name="total${product.id}"
									 id="total${product.id}"
									value="${product.price}" onblur="calculatePrice(${product.id})" /></td>


								<td><a
									href="ProductDatabaseController?action=deleteFromCart&index=${status.index}">Remove</a></td>
							</tr>
