		...
		<div id="templatemo_content">
			...
			<div id="templatemo_content_left">
				<div class="templatemo_content_left_section">
					...
					<li><a href="ProductController?action=getAllProductByCategory&category_id=${category.categoryId }">${category.categoryCode}</a></li>
			...
			<div id="templatemo_content_right">
				<c:forEach items="${list}" var="product" varStatus="status">
					<div class="templatemo_product_box">
						<h1>${product.productCode}
							<span>(by Best Author)</span>
						</h1>
						...
						<div class="product_info">
							...
							<div class="buy_now_button">
								<a href="ProductController?action=addToCart&productid=${product.productId}">Buy Now</a>
							</div>
							<div class="detail_button">
								<a href="ProductController?action=getProductById&productid=${product.productId}">Detail</a>
							</div>
						</div>
